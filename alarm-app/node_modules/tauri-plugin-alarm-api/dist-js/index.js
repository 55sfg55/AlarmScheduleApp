...
async function setAlarm(options) {
    return await invoke('plugin:alarm|set_alarm', {
        payload: options,
    });
}
/**
...
async function cancelAlarm(id) {
    await invoke('plugin:alarm|cancel_alarm', {
        payload: { id },
    });
}
/**
...
async function listAlarms() {
    const result = await invoke('plugin:alarm|list_alarms', {
        payload: {},
    });
...
async function checkExactAlarmPermission() {
    return await invoke('plugin:alarm|check_exact_alarm_permission', { payload: {} });
}
/**
...
async function openExactAlarmSettings() {
    await invoke('plugin:alarm|open_exact_alarm_settings', {
        payload: {},
    });
}

export { cancelAlarm, checkExactAlarmPermission, listAlarms, openExactAlarmSettings, setAlarm };
